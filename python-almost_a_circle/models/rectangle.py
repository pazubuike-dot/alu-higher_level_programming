...
class Rectangle(Base):
    ...
    def height(self, value):
        if type(value) is not int: raise TypeError("height must be an integer")
    ...
    @x.setter
    def x(self, value):
        if type(value) is not int: raise TypeError("x must be an integer")
    ...
    @y.setter
    def y(self, value):
        if type(value) is not int: raise TypeError("y must be an integer")
